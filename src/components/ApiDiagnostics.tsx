...
export const ApiDiagnostics = () => {
  ...
  const runDiagnostics = async () => {
    ...
    // Test 2: Quote
    try {
      logApiCall(ENDPOINTS.MARKET_DATA, 'POST', { dataType: 'quote', symbol: 'SPY' });
      const response = await fetch(ENDPOINTS.MARKET_DATA, {
        method: 'POST',
        headers: REQUEST_CONFIG.DEFAULT_HEADERS,
    ...
    try {
      ...
      logApiCall(ENDPOINTS.MARKET_DATA, 'POST', barData);
      const response = await fetch(ENDPOINTS.MARKET_DATA, {
        method: 'POST',
        headers: REQUEST_CONFIG.DEFAULT_HEADERS,
    ...
    // Test 4: Options
    try {
      logApiCall(ENDPOINTS.MARKET_DATA, 'POST', { dataType: 'options', symbol: 'SPY' });
      const response = await fetch(ENDPOINTS.MARKET_DATA, {
        method: 'POST',
        headers: REQUEST_CONFIG.DEFAULT_HEADERS,
